...
var listPermissions = () => createAuthEndpoint(
  "/rbac/permissions",
  {
    method: "GET",
    use: [sessionMiddleware]
...
var getPermission = () => createAuthEndpoint(
...
var updatePermission = (options) => createAuthEndpoint(
  "/rbac/permissions/:permissionId",
  {
    method: "POST",
    use: [sessionMiddleware],
...
var deletePermission = (options) => createAuthEndpoint(
...
var createTenantRole = (options) => createAuthEndpoint(
...
var updateTenantRole = (options) => createAuthEndpoint(
  "/rbac/tenants/:tenantId/roles/:roleId",
  {
    method: "POST",
    use: [sessionMiddleware],
...
var deleteTenantRole = (options) => createAuthEndpoint(
...
var assignRole = (options) => createAuthEndpoint(
...
var removeRole = (options) => createAuthEndpoint(
...
var checkAnyPermission = () => createAuthEndpoint(
...
var checkAllPermissions = () => createAuthEndpoint(
...
export { hasAllPermissions, hasAnyOnePermission, hasPermission, rbac };
